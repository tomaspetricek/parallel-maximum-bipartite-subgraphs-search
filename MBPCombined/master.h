...
namespace pdp::process {
    class master {
        ...
        finder::state best_;
        finder::explorer slave_explorer_;
        finder::data_parallel finder_;

    public:
        explicit master(boost::mpi::communicator world, graph::edge_list graph,
                finder::explorer master_explorer, finder::explorer slave_explorer)
